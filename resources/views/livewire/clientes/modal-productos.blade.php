<div>
    ...
    <x-dialog-modal-xl wire:model.live="openP">
        ...
        @endslot
        @slot('content')
            <div class=" py-6 px-4 bg-blue-100 flex">
                    ...
                    <table class="w-full text-sm text-center text-gray-500 mb-5">
                        ...
                        <tbody x-data="{ descriptions: {}, maxValues: {}, minValues: {} }">
                            ...
                            @foreach ($products as $product)
                                <tr class="table-row bg-white border-b text-center hover:bg-orange-50">
                                    <td class="w-1/18">
                                    ...
                                    <td class="w-1/4">
                                        ...
                                        @else
                                            <textarea rows="1" id="description-{{ $product->id }}" disabled wire:model="description.{{ $product->id }}"

            ...
            @slot('content')
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="relative z-0 w-full  group">
                        ...
                        <select class="form-control w-full" wire:model='form.presentation_id'>
                            <option value="" selected>Seleccione una presentación</option>
                            @foreach ($presentations as $presentation)
                                <option value="{{ $presentation->id }}">{{ $presentation->name }}</option>
                            @endforeach
                        </select>
                        <x-input-error for="form.presentation_id" />
                    </div>
                    <div class="relative z-0 w-full group">
                    ...
                    <div class="relative z-0 w-full  group">
                        ...
                        <select class="form-control w-full" wire:model='form.grammage_id'>
                        ...
                        <x-input-error for="form.grammage_id" />
                    </div>
                    ...
                    <div class="relative z-0 w-full  group">
                        ...
                        <select class="form-control w-full" wire:model='form.brand_id'>

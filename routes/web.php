...
Route::middleware([
    ...
    Route::get('admin/clientes/crear', CreateCliente::class)->name('clientes.crear');
    ...
    //EXPORT PDF'S
    Route::get('export/pdf/order/{order}', [ExportPDFController::class, 'OrderPDF'])->name('pdf.order');
